#!/usr/bin/env bash
# FindIPSec FortiGate VPN Client - openSUSE Leap / Tumbleweed Installer
...
info "Starting openSUSE family installation for FindIPSec VPN..."

# 1. Install prerequisites via zypper
info "Installing build dependencies via zypper..."
sudo zypper install -y gcc gcc-c++ make libopenssl-devel gtk3-devel webkit2gtk-4_1-devel \
